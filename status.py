...
# Source: https://github.com/Starwhooper/RPi-status-on-OLED-luna
...
#     alert=''
 for _ in range(2):
    with luma.core.render.canvas(device) as draw:
        draw.text((0,0), 'Hello', fill="cyan")
        draw.text((0,10), 'World!', fill="purple")
        draw.text((0,10), time(), fill="purple")
